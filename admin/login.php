                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    <div class="brand-logo pb-5">
                        <a href="<?php echo $path; ?>" class="logo-link">
                            <img class="logo-light logo-img logo-img-lg" style="opacity: 1;width: 100%;height: 37px !important;margin-left: 18%;" src="<?php echo $path; ?>assets/images/jumboking-logo-white.png" srcset="<?php echo $path; ?>assets/images/jumboking-logo-white.png 2x" alt="logo">
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h5 class="nk-block-title" style="color: #fff; text-align: center;">Admin Panel</h5>
