...
<?php
    //get user list
    $userlist = $db->prepare("SELECT * FROM consumer WHERE requestpaid = 1 order by consumerid DESC");
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Total Users Lists</h3>
                                                                    ...
                                                                    <table class="table table-bordered table-condensed" cellspacing="0" rules="all" border="1" style="width:100%;border-collapse:collapse;">
                                                                        <tbody>
                                                                            ...
                                                                            while($fetchcount1 = $userlist->fetch(PDO::FETCH_ASSOC)){
                                                                                ...
                                                                                $consumeridnnew = $fetchcount1['consumerid'];
                                                                                ...
                                                                                $status1n = $fetchcount1['requestpaid'];
                                                                                if($status1n == '0'){
                                                                                    $status1m = 'Not paid';
                                                                                    ...
                                                                                    $status1m = 'Requested';
                                                                                    $bgname1b = 'badge-gray';
                                                                                    $idname1 = 'activateuser';
                                                                                }else if($status1n == '2'){
                                                                                    $status1m = 'Banned';
                                                                                    $bgname1b = 'badge-danger';
                                                                                }else if($status1n == '3'){
                                                                                    $status1m = 'Paid';
                                                                                ...
                                                                                echo '<!-- result starts -->
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <div class="'.$idname1.'" style="float: left;" data-spon="'.$fsponsorid1.'" data-userid="'.$funiqueid1.'" data-rel="updateuserstatus"></div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <!-- user list ends -->';
                                                                                    $in++;
