                                                                        ...
                                                                        <div class="mgt-item">
                                                                            <div class="mgt-item-parent">
                                                                                <div class="person">
                                                                                    ...
                                                                                    <p class="name" style="margin-top: -5px"><?php echo $funiqueid;?></p>
                                                                                </div>
                                                                            </div>
                                                                            <!-- level starts -->
                                                                            <div class="mgt-item-children">
                                                                                            ...
                                                                                            <div class="mgt-item">
                                                                                                <div class="mgt-item-parent">
                                                                                                    <div class="person">
                                                                                                        ...
                                                                                                        <p class="name" style="margin-top: -5px"><?php echo $funiqueidn;?></p>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <!-- level starts -->
                                                                                                    <div class="mgt-item-children">
                                                                                                        ...
                                                                                                        <?php
                                                                                                            //check details 
                                                                                                            $checkdtnownn = $db->prepare("SELECT * FROM consumer WHERE nomineeid = :nomineeid order by consumerid ASC limit 0,3");
                                                                                                                ...
                                                                                                                <div class="mgt-item-child">
                                                                                                                    <div class="mgt-item">
                                                                                                                        <div class="mgt-item-parent">
                                                                                                                            <div class="person">
                                                                                                                                <img src="https://cdn0.iconfinder.com/data/icons/user-pictures/100/matureman1-128.png" alt="">
                                                                                                                                <p class="name"><?php echo $fnamenn;?></p>
                                                                                                                                <p class="name"><?php echo $uniquecodenn;?></p>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
