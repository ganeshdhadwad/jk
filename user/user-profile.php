                                            ...
                                            <div class="nk-block-head-content">
                                                ...
                                                <div style="float: right;">
                                                    <div class="form-group" >
                                                        <a href="<?php echo $path; ?>user/user-edit-profile">
                                                            <button type="submit" class="btn btn-lg btn-primary" style="background-color: #6576ff;">
                                                                Edit details
                                                            </button>
                                                        </a>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" class="form-control" id="password" placeholder="Write password" disabled value="<?php echo $passwordn; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
