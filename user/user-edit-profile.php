                            ...
                            <div class="nk-content-body">
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <div class="nk-block-head-sub"><a class="back-to" href="<?php echo $path.'user/user-profile'; ?>"><em class="icon ni ni-arrow-left"></em><span>User Profile</span></a></div>
                                    ...
                                    <div class="code-block">
                                            <div class="form-group" >
                                                <button type="submit" class="btn btn-lg btn-primary" id="updatenewuser" inform="updatenewuser" style="background-color: #6576ff;">Update details</button>
                                            </div>
                                        </div><!-- .code-block -->
                                    </div><!-- .nk-block -->
