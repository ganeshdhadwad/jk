                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block nk-block-lg">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" class="form-control" id="nomineeid" placeholder="Write nominee id"  value="<?php echo $staffuniqueid; ?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="code-block">
                                            <div class="form-group" >
                                                <button type="submit" class="btn btn-lg btn-primary" id="addnewuser" inform="addnewuser" style="background-color: #6576ff;">Generate Account</button>
                                            </div>
                                        </div><!-- .code-block -->
