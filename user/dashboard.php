<?php
    ...
    //echo $userid.'--this is test user id';
    if($userid > 0){
    ...
    $consumeremail = $fetchstaff['consumeremail'];
    $consumeruucode = $fetchstaff['uniqueid'];
    //echo $consumerfname;
    //now count total user
    $nomineeusercount = $db->prepare("SELECT * FROM consumer WHERE nomineeid = :nomineeid");
    $nomineeusercount->bindParam(":nomineeid", $consumeruucode);
    $nomineeusercount->execute();
    //now count
    $nominecount = $nomineeusercount->rowCount();
    $usercode2 = $db->prepare("SELECT * FROM treed WHERE treeuniquecode = :treeuniquecode");
    $usercode2->bindParam(":treeuniquecode", $consumeruucode);
    $usercode2->execute();
    //check count 
    $ucount2 = $usercode2->rowCount();

    //count all money of the user
    $moneycount = $db->prepare("SELECT sum(amount) as totalamount FROM walletdt WHERE walletuserid = :userid");
    $moneycount->bindParam(":userid", $userid);
    $moneycount->execute();
    //count now
    $rown = $moneycount->fetch(PDO::FETCH_ASSOC);
    $moneytcount = $rown['totalamount'];
    //echo $moneytcount;
?>
<!DOCTYPE html>
...
<head>
    ...
    <!-- Page Title  -->
    <title><?php echo $website_name; ?> - User Dashboard</title>
    <!-- StyleSheets  -->
                            ...
                            <div class="nk-content-body">
                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>Welcome to <?php echo $website_name; ?> User panel.</p>
                                            </div>
                                ...
                                <div class="nk-block">
                                    <div class="row g-gs">
                                                            ...
                                                            <div class="align-end gy-3 gx-5 flex-wrap flex-md-nowrap flex-lg-wrap flex-xxl-nowrap">
                                                                <div class="nk-sale-data-group flex-md-nowrap g-4">
                                                                    <div class="nk-sale-data">
                                                                        <span class="amount" style="font-size: 14px;"><?php echo $consumerfname.'&nbsp;&nbsp;'.$consumerlname.'<br/>'.$consumeremail; ?> <span class="change down text-danger" style="display: none;"><em class="icon ni ni-arrow-long-down"></em>16.93%</span></span>
                                                                        <span class="sub-title">This Month</span>
                                                                    </div>
                                                                    <div class="nk-sale-data" style="display: none;">
                                                                ...
                                                                <div class="nk-sales-ck sales-revenue" style="display: none;">
                                                            ...
                                                            <div class="card card-bordered">
                                                                <div class="card-inner">
                                                                    ...
                                                                    <div class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                                                        <div class="nk-sale-data">
                                                                            <span class="amount"><?php echo $nominecount; ?></span>
                                                                            <span class="sub-title" ><span class="change down text-danger" style="display: none;"><em class="icon ni ni-arrow-long-down"></em>1.93%</span>since last month</span>
                                                                        </div>
                                                                        <div class="nk-sales-ck" style="display: none;">
                                                ...
                                                <div class="card-inner">
                                                    <div class="card-title-group align-start gx-3 mb-3">
                                                        <div class="card-title">
                                                            ...
                                                            <p style="display: none;">In 30 days sales of product subscription. <a href="#">See Details</a></p>
                                                        </div>
                                                    ...
                                                    <div class="nk-sale-data-group align-center justify-between gy-3 gx-5">
                                                        <div class="nk-sale-data">
                                                            <span class="amount"><?php echo $currencysymbol.'&nbsp;'.$moneytcount; ?></span>
                                                        </div>
                                                        <div class="nk-sale-data" style="display: none;">
                                                            <span class="amount sm">1,937 <small>Subscribers</small></span>
                                                        </div>
                                                    </div>
                                                    <div class="nk-sales-ck large pt-4" style="display: none;">
                                        ...
                                        <div class="col-lg-6 col-xxl-4" style="display: none;">
                                            <div class="card card-bordered h-100">
                                                <div class="card-inner border-bottom">
                                                    <div class="card-title-group">
                                                        <div class="card-title">
