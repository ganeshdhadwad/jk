...
<?php
    $pstatus = '1';
    //get user list
    $userlist = $db->prepare("SELECT * FROM product WHERE status = :status order by productid DESC");
    $userlist->bindParam(":status", $pstatus);
    $userlist->execute();
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Total Product Lists</h3>
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="<?php echo $path; ?>staff/add-product"><span>Add Product</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
                                                                ...
                                                                <div>
                                                                    <table class="table table-bordered table-condensed" cellspacing="0" rules="all" border="1" style="width:100%;border-collapse:collapse;">
                                                                        <tbody>
                                                                            ...
                                                                            // $checkdtnow1->execute();
                                                                            $in = '1';
                                                                            $bgname2 = 'deleteproducts';
                                                                            $count1 = $userlist->rowCount();
                                                                            while($fetchcount1 = $userlist->fetch(PDO::FETCH_ASSOC)){
                                                                                $productname = $fetchcount1['productname'];
                                                                                $productid = $fetchcount1['productid'];
                                                                                $productdesc = $fetchcount1['productdescription'];
                                                                                $productimg = $fetchcount1['imgname'];
                                                                                ...
                                                                                echo '<!-- result starts -->
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <span class="tb-sub text-primary" style="text-align: center;">'. $productid.'</span>
                                                                                                    </td>
                                                                                                    <td style="text-align: center;">
                                                                                                        '. ucfirst($productname) .'
                                                                                                    </td>
                                                                                                    ...
                                                                                                    <td style="text-align: center;"><img src="'.$path.'uploads/'.$productimg.'" style="width: 50px; height: 50px;"/></td>
                                                                                                    <td style="text-align: center;">
                                                                                                        '. $productdesc .'
                                                                                                    </td>
                                                                                                    <td><div id="'.$bgname2.'" style="float: left; font-size: 11px;" inform="'.$bgname2.'" data-rel="'.$productid.'"></div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <!-- user list ends -->';
                                                                                    $in++;
