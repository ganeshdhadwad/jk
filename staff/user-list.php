...
<?php
    //get user list
    $userlist = $db->prepare("SELECT * FROM consumer order by consumerid DESC");
                                                                            ...
                                                                            while($fetchcount1 = $userlist->fetch(PDO::FETCH_ASSOC)){
                                                                                ...
                                                                                echo '<!-- result starts -->
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <div class="'.$bgname1.'" style="text-align: center; border-radius: 3px; font-size: 11px;">'.$status1.'</div>
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <div id="editadminuser" style="float: left;" data-rel="'.$consumeridnnew.'"></div> <div id="'.$bgname2.'" style="float: left; font-size: 11px;" inform="'.$bgname2.'" data-rel="'.$consumeridnnew.'"></div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <!-- user list ends -->';
                                                                                    $in++;
