<header id="masthead" class="site-header header-v1"  style="background-color: #59981A !important; ">
            <div class="col-full">
                                                      ...
                                                      <div class="widget widget_nav_menu kc-elm kc-css-1908114">
                                                         <div class="menu-pages-menu-1-container">
                                                            <ul id="menu-pages-menu-5" class="menu">
                                                               ...
                                                               ?>
                                                               <li class="nav-title menu-item" style="float: left; margin-right: 76px;"><a href="<?php 
                                                               if($smenuseoname == 'zomato-order'){
                                                                   $menupath = 'https://www.zomato.com/mumbai/restaurants/jumboking-indian-burger';
                                                                   $target = "_blank";
                                                               }else if($smenuseoname == 'swiggy-order'){
                                                                   $menupath = 'https://www.swiggy.com/search?q=Jumboking+Indian+Burger';
                                                                   $target = "_blank";
                                                               }else{
                                                                   $menupath = $path.$smenuseoname;
                                                                   $target = "_self";
                                                               }
                                                               echo $menupath; ?>" target="<?php echo $target; ?>"><?php echo $smenuname; ?></a></li>
                                                               <?php 
                                                                     } 
                                                                  $n++;
                                                                  } 
