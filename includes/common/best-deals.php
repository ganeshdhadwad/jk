<div id="woocommerce_products-2" class="widget woocommerce widget_products">
                     ...
                     <ul class="product_list_widget">
                        <li>
                           ...
                           <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"><?php echo $currency; ?></span>1.90</span>
                           </span>
                        </li>
                        <li>
                           ...
                           <span class="widget-price">
                           <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"><?php echo $currency; ?></span>2.90</span>
                           </span>
                        </li>
                        <li>
                           ...
                           <span class="widget-price">
                           <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"><?php echo $currency; ?></span>39.80</span>&ndash;<span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"><?php echo $currency; ?></span>59.90</span>
                           </span>
                        </li>
                        <li>
                           ...
                           <span class="widget-price">
                           <del><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"><?php echo $currency; ?></span>22.90</span></del>
                           <ins><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"><?php echo $currency; ?></span>19.90</span></ins>
                           </span>
                        </li>
                     </ul>
                  </div>